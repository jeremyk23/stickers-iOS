...
@interface RestaurantViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, ERequestInterfaceDelegate, FSPhotoGalleryCollectionViewDelegate,  UICollectionViewDelegateFlowLayout,  StickersCollectionViewDelegate>

@property (weak, nonatomic) IBOutlet FSPhotoGalleryCollectionView *photoGalleryView;
